		...
		Layout(gtx, layout.Center, func() {
			...
			layout.Stack{Alignment: layout.Center}.Layout(gtx,
				layout.Expanded(func() {
					...
					pointer.Rect(
						image.Rectangle{Max: gtx.Dimensions.Size}).Add(gtx.Ops)
				}),
				layout.Stacked(func() {
					...
					layout.Center.Layout(gtx, func() {
						layout.Inset{Top: unit.Dp(16), Bottom: unit.Dp(16),
										...
										layout.Flex{
											...
											layout.Rigid(
												dialogButon(gtx, th,
													...
													buttonDialogCancel)),
											layout.Rigid(dialogButon(gtx, th,
