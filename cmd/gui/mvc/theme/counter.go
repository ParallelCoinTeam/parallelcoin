...
////	//
////
////	layout.Stack{}.Layout(duo.Context,
////		layout.Stacked(func() {
////			layout.Flex{}.Layout(duo.Context,
...
////					layout.Flex{Axis: layout.Horizontal}.Layout(duo.Context,
////						layout.Rigid(func() {
////							//cs := duo.Context.Constraints
////							//helpers.DrawRectangle(duo.Context, cs.Width.Max, 120, "ff3030cf", [4]float32{0, 0, 0, 0}, [4]float32{0, 0, 0, 0})
////							in := layout.UniformInset(unit.Dp(0))
////							in.Layout(duo.Context, func() {
////								layout.Align(layout.Center).Layout(duo.Context, func() {
////									duo.Theme.Body2(fmt.Sprint(itemValue.i)).Layout(duo.Context)
////								})
////							})
////						}),
...
//	for _, e := range duo.Context.Events(b) { // HLevent
...
//	).Add(duo.Context.Ops)                       // HLevent
//	pointer.InputOp{Key: b}.Add(duo.Context.Ops) // HLevent
//	//helpers.DrawRectangle(gtx, cs.Width.Max, cs.Height.Max, colorBorder, b.BorderRadius, unit.Dp(0))
//	helpers.DuoUIdrawRectangle(duo.Context, cs.Width.Max, 32, colorBorder, [4]float32{0, 0, 0, 0}, [4]float32{0, 0, 0, 0})
//
//	in := layout.UniformInset(border)
//	in.Layout(duo.Context, func() {
//		//helpers.DrawRectangle(duo.Context, cs.Width.Max, cs.Height.Max, colorBg, b.BorderRadius, unit.Dp(0))
//		helpers.DuoUIdrawRectangle(duo.Context, cs.Width.Max, 30, colorBg, [4]float32{0, 0, 0, 0}, [4]float32{0, 0, 0, 0})
//		//cs := gtx.Constraints
//		label := duo.Theme.Caption(b.Name)
//		label.Alignment = text.Middle
//		label.Layout(duo.Context)
//	})
//}
...
func (b DuoUIcounter) Layout(gtx *layout.Context, button *controller.Counter) {
	col := b.TxColor
	bgcol := b.BgColor
