...
func WalletStatus() mod.DuOScomp {
	return mod.DuOScomp{
		IsApp:    true,
		Name:     "Wallet status",
		...
		Template: `<div tabindex="0"  id="panelwalletstatus" class="flx flc justifyBetween duoCard Balance"><div class="e-card-header"><div class="e-card-header-caption"><div class="e-card-header-title">Balance:</div><div class="e-card-sub-title"><span v-html="this.duOSys.status.balance.balance"></span> DUO</div></div><div class="e-card-header-image balance"></div></div><div class="flx flc e-card-content"><small><span>Pending: </span><strong><span v-html="this.duOSys.status.balance.unconfirmed"></span></strong></small><small><span>Transactions: </span><strong><span v-html="this.duOSys.status.txsnumber"></span></strong></small></div></div>`,
		Css: `
...
func LocalHashRate() mod.DuOScomp {
	return mod.DuOScomp{
		IsApp:    true,
		Name:     "Local Hashrate",
...
func NetworkHashRate() mod.DuOScomp {
	return mod.DuOScomp{
		IsApp:    true,
