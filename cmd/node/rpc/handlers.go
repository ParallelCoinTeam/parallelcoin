...
func HandleGenerate(
	...
	L.Debug("cpu miner stuff is missing here")
...
func HandleGetCFilter(
	...
	L.Trace("found committed filter for", hash)
...
func HandleGetGenerate(
	...
	if generating {
		L.Debug("miner is running internally")
	} else {
		L.Debug("miner is not running")
	}
	// return nil, nil
...
func HandleGetHashesPerSec(
	...
	L.Debug("miner hashes per second - multicast thing TODO")
...
func HandleGetMiningInfo(s *Server, cmd interface{},
	...
	case 0:
		...
		L.Debug("missing generate stats in here")
	...
	case 1:
		...
		L.Debug("missing cpu miner stuff in here") // cpuminer
...
func HandleSetGenerate(
	...
	L.Debug("generating", generate, "threads", genProcLimit)
	...
	*s.Config.GenThreads = genProcLimit
	if s.Cfg.CPUMiner != nil {
		L.Debug("stopping existing process")
		err := s.Cfg.CPUMiner.Process.Kill()
		if err != nil {
			L.Error(err)
		}
	}
	L.Debug("saving configuration")
	save.Pod(s.Config)
	if *s.Config.Generate && *s.Config.GenThreads != 0 {
		L.Debug("starting miner")
