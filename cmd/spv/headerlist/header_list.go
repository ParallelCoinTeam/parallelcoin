...
// but allows implementations to use custom storage backends and semantics.
...
// Node is a node within the Chain. Each node stores a header as well as a height. Nodes can also be used to traverse
// the chain backwards via their Prev() method.
type Node struct {
...
// Prev attempts to access the prior node within the header chain relative to this node. If this is the start of the
// chain, then this method will return nil.
