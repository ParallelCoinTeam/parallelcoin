...
const (
	...
	// These constants define the application version and follow the semantic versioning 2.0.0 spec
	// (http://semver.org/).
	appMajor uint = 0
	appMinor uint = 8
	appPatch uint = 0
...
func Version() string {
	...
	// Append pre-release version if there is one. The hyphen called for by the semantic versioning spec is
	// automatically appended and should not be contained in the pre-release string. The pre-release version is not
