...
const (
	// BlockConnectedNtfnMethod is the legacy, deprecated method used for notifications from the chain server that a
	// block has been connected. NOTE: Deprecated. Use FilteredBlockConnectedNtfnMethod instead.
	BlockConnectedNtfnMethod = "blockconnected"
	// BlockDisconnectedNtfnMethod is the legacy, deprecated method used for notifications from the chain server that a
	// block has been disconnected. NOTE: Deprecated. Use FilteredBlockDisconnectedNtfnMethod instead.
	BlockDisconnectedNtfnMethod = "blockdisconnected"
	// FilteredBlockConnectedNtfnMethod is the new method used for notifications from the chain server that a block has
	// been connected.
	FilteredBlockConnectedNtfnMethod = "filteredblockconnected"
	// FilteredBlockDisconnectedNtfnMethod is the new method used for notifications from the chain server that a block
	// has been disconnected.
	FilteredBlockDisconnectedNtfnMethod = "filteredblockdisconnected"
	// RecvTxNtfnMethod is the legacy, deprecated method used for notifications from the chain server that a transaction
	// which pays to a registered address has been processed. NOTE: Deprecated. Use RelevantTxAcceptedNtfnMethod and
	// FilteredBlockConnectedNtfnMethod instead.
	RecvTxNtfnMethod = "recvtx"
	// RedeemingTxNtfnMethod is the legacy, deprecated method used for notifications from the chain server that a
	// transaction which spends a registered outpoint has been processed. NOTE: Deprecated. Use
	// RelevantTxAcceptedNtfnMethod and FilteredBlockConnectedNtfnMethod instead.
	RedeemingTxNtfnMethod = "redeemingtx"
	// RescanFinishedNtfnMethod is the legacy, deprecated method used for notifications from the chain server that a
	// legacy, deprecated rescan operation has finished. NOTE: Deprecated. Not used with rescanblocks command.
	RescanFinishedNtfnMethod = "rescanfinished"
	// RescanProgressNtfnMethod is the legacy, deprecated method used for notifications from the chain server that a
	// legacy, deprecated rescan operation this is underway has made progress. NOTE: Deprecated. Not used with
	// rescanblocks command.
	RescanProgressNtfnMethod = "rescanprogress"
	// TxAcceptedNtfnMethod is the method used for notifications from the chain server that a transaction has been
	// accepted into the mempool.
	TxAcceptedNtfnMethod = "txaccepted"
	// TxAcceptedVerboseNtfnMethod is the method used for notifications from the chain server that a transaction has
	// been accepted into the mempool.  This differs from TxAcceptedNtfnMethod in that it provides more details in the
	// notification.
...
// NewBlockConnectedNtfn returns a new instance which can be used to issue a blockconnected JSON-RPC notification. NOTE:
...
// BlockDisconnectedNtfn defines the blockdisconnected JSON-RPC notification. NOTE: Deprecated. Use
// FilteredBlockDisconnectedNtfn instead.
...
// NewFilteredBlockConnectedNtfn returns a new instance which can be used to issue a filteredblockconnected JSON-RPC
// notification.
...
// RecvTxNtfn defines the recvtx JSON-RPC notification. NOTE: Deprecated. Use RelevantTxAcceptedNtfn and
// FilteredBlockConnectedNtfn instead.
type RecvTxNtfn struct {
	HexTx string
	Block *BlockDetails
}

// NewRecvTxNtfn returns a new instance which can be used to issue a recvtx JSON-RPC notification. NOTE: Deprecated.
// Use NewRelevantTxAcceptedNtfn and NewFilteredBlockConnectedNtfn instead.
...
// RedeemingTxNtfn defines the redeemingtx JSON-RPC notification. NOTE: Deprecated. Use RelevantTxAcceptedNtfn and
// FilteredBlockConnectedNtfn instead.
...
// NewRedeemingTxNtfn returns a new instance which can be used to issue a redeemingtx JSON-RPC notification. NOTE:
...
// RescanFinishedNtfn defines the rescanfinished JSON-RPC notification. NOTE: Deprecated. Not used with rescanblocks
// command.
...
// RescanProgressNtfn defines the rescanprogress JSON-RPC notification. NOTE: Deprecated. Not used with rescanblocks
// command.
...
// NewRelevantTxAcceptedNtfn returns a new instance which can be used to issue a relevanttxaccepted JSON-RPC
// notification.
