...
var Dial = func(stateCfg *state.Config) func(addr net.Addr) (conn net.Conn, err error) {
	return func(addr net.Addr) (conn net.Conn, err error) {
...
var Lookup = func(stateCfg *state.Config) func(host string) (addrs []net.IP, err error) {
	return func(host string) (addrs []net.IP, err error) {
