...
This client provides a robust and easy to use client for interfacing with a Bitcoin RPC server that uses a pod/bitcoin core compatible Bitcoin JSON-RPC API.  This client has been tested with pod (https://git.parallelcoin.io/dev/pod), btcwallet (https://git.parallelcoin.io/dev/pod/wallet), and bitcoin core (https://github.com/bitcoin).
