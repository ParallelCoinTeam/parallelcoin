...
func (r FutureGenerateResult) Receive() ([]*chainhash.Hash, error) {
	...
	for i, hashString := range result {
		convertedResult[i], e = chainhash.NewHashFromStr(hashString)
		if e != nil {
			return nil, e
		}
	}
...
// GenerateAsync returns an instance of a type that can be used to get the result of the RPC at some future time by
// invoking the Receive function on the returned instance. See Generate for the blocking version and more details.
...
// GetGenerateAsync returns an instance of a type that can be used to get the result of the RPC at some future time by
// invoking the Receive function on the returned instance. See GetGenerate for the blocking version and more details.
...
// FutureSetGenerateResult is a future promise to deliver the result of a SetGenerateAsync RPC invocation (or an
// applicable error).
type FutureSetGenerateResult chan *response

// Receive waits for the response promised by the future and returns an error if any occurred when setting the server to
// generate coins (mine) or not.
func (r FutureSetGenerateResult) Receive() (e error) {
	_, e = receiveFuture(r)
	return e
}
...
func (c *Client) SetGenerate(enable bool, numCPUs int) (e error) {
	return c.SetGenerateAsync(enable, numCPUs).Receive()
}

// FutureGetHashesPerSecResult is a future promise to deliver the result of a GetHashesPerSecAsync RPC invocation (or an
// applicable error).
type FutureGetHashesPerSecResult chan *response

// Receive waits for the response promised by the future and returns a recent hashes per second performance measurement
// while generating coins (mining). Zero is returned if the server is not mining.
...
// GetHashesPerSecAsync returns an instance of a type that can be used to get the result of the RPC at some future time
// by invoking the Receive function on the returned instance. See GetHashesPerSec for the blocking version and more
// details.
...
// GetHashesPerSec returns a recent hashes per second performance measurement while generating coins (mining). Zero is
// returned if the server is not mining.
func (c *Client) GetHashesPerSec() (int64, error) {
	return c.GetHashesPerSecAsync().Receive()
}

// FutureGetMiningInfoResult is a future promise to deliver the result of a GetMiningInfoAsync RPC invocation (or an
// applicable error).
...
// GetMiningInfoAsync returns an instance of a type that can be used to get the result of the RPC at some future time by
// invoking the Receive function on the returned instance. See GetMiningInfo for the blocking version and more details.
...
// GetNetworkHashPSAsync returns an instance of a type that can be used to get the result of the RPC at some future time
// by invoking the Receive function on the returned instance. See GetNetworkHashPS for the blocking version and more
// details.
...
// GetNetworkHashPS2Async returns an instance of a type that can be used to get the result of the RPC at some future
// time by invoking the Receive function on the returned instance. See GetNetworkHashPS2 for the blocking version and
// more details.
...
// GetNetworkHashPS3Async returns an instance of a type that can be used to get the result of the RPC at some future
...
// GetWorkAsync returns an instance of a type that can be used to get the result of the RPC at some future time by
...
// FutureGetWorkSubmit is a future promise to deliver the result of a GetWorkSubmitAsync RPC invocation (or an
// applicable error).
type FutureGetWorkSubmit chan *response

// Receive waits for the response promised by the future and returns whether or not the submitted block header was
// accepted.
...
// GetWorkSubmitAsync returns an instance of a type that can be used to get the result of the RPC at some future time by
// invoking the Receive function on the returned instance. See GetWorkSubmit for the blocking version and more details.
func (c *Client) GetWorkSubmitAsync(data string) FutureGetWorkSubmit {
	cmd := btcjson.NewGetWorkCmd(&data)
	return c.sendCmd(cmd)
}

// GetWorkSubmit submits a block header which is a solution to previously requested data and returns whether or not the
// solution was accepted. See GetWork to request data to work on.
func (c *Client) GetWorkSubmit(data string) (bool, error) {
	return c.GetWorkSubmitAsync(data).Receive()
}

// FutureSubmitBlockResult is a future promise to deliver the result of a SubmitBlockAsync RPC invocation (or an
// applicable error).
...
func (r FutureSubmitBlockResult) Receive() (e error) {
	res, e := receiveFuture(r)
	if e != nil {
		return e
	}
