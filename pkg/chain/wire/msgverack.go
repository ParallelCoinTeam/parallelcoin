...
func (msg *MsgVerAck) BtcDecode(r io.Reader, pver uint32, enc MessageEncoding) (err error) {
	return nil
}
...
func (msg *MsgVerAck) BtcEncode(w io.Writer, pver uint32, enc MessageEncoding) (err error) {
	return nil
}
