...
func (h *BlockHeader) BtcDecode(r io.Reader, pver uint32, enc MessageEncoding) (err error) {
...
func (h *BlockHeader) BtcEncode(w io.Writer, pver uint32, enc MessageEncoding) (err error) {
...
func (h *BlockHeader) Deserialize(r io.Reader) (err error) {
...
func (h *BlockHeader) Serialize(w io.Writer) (err error) {
...
func readBlockHeader(r io.Reader, pver uint32, bh *BlockHeader) (err error) {
...
func writeBlockHeader(w io.Writer, pver uint32, bh *BlockHeader) (err error) {
