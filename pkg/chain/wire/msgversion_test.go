...
// 	}
// 	// Make a new buffer big enough to hold the base version plus the new bytes for the bigger varint to hold the new
//	size of the user agent and the new user agent string.  Then stitch it all together.
