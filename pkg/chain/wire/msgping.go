...
func (msg *MsgPing) BtcDecode(r io.Reader, pver uint32, enc MessageEncoding) (err error) {
...
func (msg *MsgPing) BtcEncode(w io.Writer, pver uint32, enc MessageEncoding) (err error) {
	// There was no nonce for BIP0031Version and earlier. NOTE: > is not a mistake here.  The BIP0031 was defined as AFTER the version unlike most others.
	if pver > BIP0031Version {
