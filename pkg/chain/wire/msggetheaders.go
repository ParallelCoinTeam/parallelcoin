...
func (msg *MsgGetHeaders) AddBlockLocatorHash(hash *chainhash.Hash) (err error) {
...
func (msg *MsgGetHeaders) BtcDecode(r io.Reader, pver uint32, enc MessageEncoding) (err error) {
	...
	if count > MaxBlockLocatorsPerMsg {
		err = messageError("MsgGetHeaders.BtcDecode", fmt.Sprintf(
...
func (msg *MsgGetHeaders) BtcEncode(w io.Writer, pver uint32, enc MessageEncoding) (err error) {
