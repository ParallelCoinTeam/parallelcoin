...
const (
	...
	// BIP0037Version is the protocol version which added new connection bloom
	// filtering related messages and extended the version message with a relay
	// flag (pver >= BIP0037Version).
	...
	// SendHeadersVersion is the protocol version which added a new sendheaders
	// message.
...
const (
	...
	// SFNodeGetUTXO is a flag used to indicate a peer supports the getutxos and
	...
	SFNodeXthin
	// SFNodeBit5 is a flag used to indicate a peer supports a service defined
	// by bit 5.
	SFNodeBit5
	// SFNodeCF is a flag used to indicate a peer supports committed filters
	// (CFs).
	SFNodeCF
...
// used to seek to the next message when a stream's state is unknown, but this
