	...
	tests := []struct {
	...
	}{
		{
			...
			p2pkhMagics: []magicTest{
				...
				{
					magic: RegressionTestParams.PubKeyHashAddrID,
					valid: true,
				},
				{
			...
			p2shMagics: []magicTest{
				...
				{
					magic: RegressionTestParams.ScriptHashAddrID,
					valid: true,
				},
				{
			...
			hdMagics: []hdTest{
				...
				{
					priv: RegressionTestParams.HDPrivateKeyID[:],
					want: RegressionTestParams.HDPublicKeyID[:],
					err:  nil,
				},
				{
