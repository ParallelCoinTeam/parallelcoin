...
[![GoDoc](https://godoc.org/github.com/parallelcointeam/parallelcoin/txscript?status.png)](http://godoc.org/github.com/parallelcointeam/parallelcoin/txscript)
...
```bash
$ go get -u github.com/parallelcointeam/parallelcoin/txscript
```

## Examples

- [Standard Pay-to-pubkey-hash Script](http://godoc.org/github.com/parallelcointeam/parallelcoin/txscript#example-PayToAddrScript)  
...
- [Extracting Details from Standard Scripts](http://godoc.org/github.com/parallelcointeam/parallelcoin/txscript#example-ExtractPkScriptAddrs)  
  Demonstrates extracting information from a standard public key script.

- [Manually Signing a Transaction Output](http://godoc.org/github.com/parallelcointeam/parallelcoin/txscript#example-SignTxOutput)  
