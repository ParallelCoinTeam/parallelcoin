...
const (
	...
	ErrSigHighS
	// ErrNotPushOnly is returned when a script that is required to only push data to the stack performs other operations.  A couple of cases where this applies is for a pay-to-script-hash signature script when
