...
// validateMsgTx verifies transaction input scripts for tx. All previous output scripts from outputs redeemed by the
// transaction, in the same order they are spent, must be passed in the prevScripts slice.
