...
const (
	// RedeemP2PKHSigScriptSize is the worst case (largest) serialize size of a transaction input script that redeems a
	// compressed P2PKH output. It is calculated as:
	//
	//   - OP_DATA_73
	...
	// P2PKHPkScriptSize is the size of a transaction output script that pays to a compressed pubkey hash. It is
	// calculated as:
	//
	//   - OP_DUP
	//   - OP_HASH160
	...
	// RedeemP2PKHInputSize is the worst case (largest) serialize size of a transaction input redeeming a compressed
	// P2PKH output. It is calculated as:
	//
	...
	// P2PKHOutputSize is the serialize size of a transaction output with a P2PKH output script. It is calculated as:
	//
	...
	// P2WPKHOutputSize is the serialize size of a transaction output with a P2WPKH output script. It is calculated as:
	//
	//   - 8 bytes output value
	...
	// RedeemNestedP2WPKHInputSize is the worst case size of a transaction input redeeming a P2SH-P2WPKH output. It is
	// calculated as:
	//
	//   - 32 bytes previous tx
	//   - 4 bytes output index
...
func EstimateVirtualSize(numP2PKHIns, numP2WPKHIns, numNestedP2WPKHIns int,
	...
	// Version 4 bytes + LockTime 4 bytes + Serialized var int size for the number of transaction inputs and outputs +
