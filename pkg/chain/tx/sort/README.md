...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/stalker-loki/pod/btcutil/txsort)
...
```bash
$ go get -u github.com/stalker-loki/pod/btcutil/txsort
```
