...
// 	if coinbaseScript, e = standardCoinbaseScript(mbt.Height, extraNonce); dbg.Chk(e) {
// 		return nil, e
// 	}
...
// 		if e = spendTransaction(blockUtxos, tx, mbt.Height); dbg.Chk(e) {
// 		}
...
// 		dbg.Ln("algo", algo)
// 		if mbt.Bits[curr()], e = g.Chain.CalcNextRequiredDifficulty(algo); dbg.Chk(e) {
// 			return nil, e
// 		}
// 		dbg.F(
