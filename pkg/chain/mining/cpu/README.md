...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/stalker-loki/pod/mining/cpuminer)
...
```bash
$ go get -u github.com/stalker-loki/pod/mining/cpuminer
```
