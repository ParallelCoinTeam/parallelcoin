...
func (l *List) init(gtx *layout.Context, len int) {
	if l.more() {
...
// Layout the List.
func (l *List) Layout(gtx *layout.Context, len int, w ListElement) {
...
func (l *List) end(dims layout.Dimensions) {
	l.child.Stop()
...
func (l *List) layout() layout.Dimensions {
	if l.more() {
		panic("unfinished child")
	}
