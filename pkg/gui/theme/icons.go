...
func NewDuoUIicons() (i map[string]*DuoUIicon) {
	...
	i["ToggleCheckBox"] = mustIcon(NewDuoUIicon(icons.ToggleCheckBox))
	i["ToggleCheckBoxOutlineBlank"] = mustIcon(NewDuoUIicon(icons.ToggleCheckBoxOutlineBlank))
	i["ToggleRadioButtonChecked"] = mustIcon(NewDuoUIicon(icons.ToggleRadioButtonChecked))
	i["ToggleRadioButtonUnchecked"] = mustIcon(NewDuoUIicon(icons.ToggleRadioButtonUnchecked))
