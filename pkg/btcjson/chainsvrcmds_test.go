...
func TestChainSvrCmds(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return btcjson.NewCmd(
					"createrawtransaction", `[{"txid":"123","vout":1}]`,
					`{"456":0.0123}`,
				)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			marshalled:   `{"jsonrpc":"1.0","method":"decoderawtransaction","netparams":["123"],"id":1}`,
		...
		},
		{
			...
			marshalled:   `{"jsonrpc":"1.0","method":"getaddednodeinfo","netparams":[true],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getaddednodeinfo","netparams":[true,"127.0.0.1"],"id":1}`,
		...
		},
		{
			...
			marshalled:   `{"jsonrpc":"1.0","method":"getbestblockhash","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getblock","netparams":["123"],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getblock","netparams":["123",true],"id":1}`,
			unmarshalled: &btcjson.GetBlockCmd{
				Hash:      "123",
				Verbose:   btcjson.Bool(true),
				VerboseTx: btcjson.Bool(false),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getblock","netparams":["123",true,true],"id":1}`,
			unmarshalled: &btcjson.GetBlockCmd{
				Hash:      "123",
				Verbose:   btcjson.Bool(true),
		...
		},
		{
			...
			marshalled:   `{"jsonrpc":"1.0","method":"getblockchaininfo","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled:   `{"jsonrpc":"1.0","method":"getblockcount","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled:   `{"jsonrpc":"1.0","method":"getblockhash","netparams":[123],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getblockheader","netparams":["123"],"id":1}`,
		...
		},
		{
			...
			marshalled:   `{"jsonrpc":"1.0","method":"getblocktemplate","netparams":[],"id":1}`,
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return btcjson.NewCmd(
					"getblocktemplate",
					`{"mode":"template","capabilities":["longpoll","coinbasetxn"]}`,
				)
			},
			staticCmd: func() interface{} {
			...
			marshalled: `{"jsonrpc":"1.0","method":"getblocktemplate","netparams":[{"mode":"template","capabilities":["longpoll","coinbasetxn"]}],"id":1}`,
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return btcjson.NewCmd(
					"getblocktemplate",
					`{"mode":"template","capabilities":["longpoll","coinbasetxn"],"sigoplimit":500,"sizelimit":100000000,"maxversion":2}`,
				)
			},
			staticCmd: func() interface{} {
				template := btcjson.TemplateRequest{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getblocktemplate","netparams":[{"mode":"template","capabilities":["longpoll","coinbasetxn"],"sigoplimit":500,"sizelimit":100000000,"maxversion":2}],"id":1}`,
			unmarshalled: &btcjson.GetBlockTemplateCmd{
				Request: &btcjson.TemplateRequest{
					Mode:         "template",
					Capabilities: []string{"longpoll", "coinbasetxn"},
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return btcjson.NewCmd(
					"getblocktemplate",
					`{"mode":"template","capabilities":["longpoll","coinbasetxn"],"sigoplimit":true,"sizelimit":100000000,"maxversion":2}`,
				)
			},
			staticCmd: func() interface{} {
				template := btcjson.TemplateRequest{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getblocktemplate","netparams":[{"mode":"template","capabilities":["longpoll","coinbasetxn"],"sigoplimit":true,"sizelimit":100000000,"maxversion":2}],"id":1}`,
			unmarshalled: &btcjson.GetBlockTemplateCmd{
				Request: &btcjson.TemplateRequest{
					Mode:         "template",
					Capabilities: []string{"longpoll", "coinbasetxn"},
		...
		},
		{
			...
			staticCmd: func() interface{} {
				return btcjson.NewGetCFilterCmd(
					"123",
					wire.GCSFilterRegular,
				)
			},
			marshalled: `{"jsonrpc":"1.0","method":"getcfilter","netparams":["123",0],"id":1}`,
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return btcjson.NewCmd(
					"getcfilterheader", "123",
					wire.GCSFilterRegular,
				)
			},
			staticCmd: func() interface{} {
				return btcjson.NewGetCFilterHeaderCmd(
					"123",
					wire.GCSFilterRegular,
				)
			},
			marshalled: `{"jsonrpc":"1.0","method":"getcfilterheader","netparams":["123",0],"id":1}`,
		...
		},
		{
			...
			marshalled:   `{"jsonrpc":"1.0","method":"getchaintips","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled:   `{"jsonrpc":"1.0","method":"getconnectioncount","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled:   `{"jsonrpc":"1.0","method":"getgenerate","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled:   `{"jsonrpc":"1.0","method":"gethashespersec","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled:   `{"jsonrpc":"1.0","method":"getinfo","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getmempoolentry","netparams":["txhash"],"id":1}`,
		...
		},
		{
			...
			marshalled:   `{"jsonrpc":"1.0","method":"getmempoolinfo","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled:   `{"jsonrpc":"1.0","method":"getmininginfo","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled:   `{"jsonrpc":"1.0","method":"getnetworkinfo","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled:   `{"jsonrpc":"1.0","method":"getnettotals","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getnetworkhashps","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getnetworkhashps","netparams":[200],"id":1}`,
			unmarshalled: &btcjson.GetNetworkHashPSCmd{
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getnetworkhashps","netparams":[200,123],"id":1}`,
			unmarshalled: &btcjson.GetNetworkHashPSCmd{
				Blocks: btcjson.Int(200),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getrawmempool","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getrawmempool","netparams":[false],"id":1}`,
			unmarshalled: &btcjson.GetRawMempoolCmd{
				Verbose: btcjson.Bool(false),
			},
		},
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"gettxout","netparams":["123",1],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"gettxout","netparams":["123",1,true],"id":1}`,
			unmarshalled: &btcjson.GetTxOutCmd{
				Txid:           "123",
				Vout:           1,
				IncludeMempool: btcjson.Bool(true),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"gettxoutproof","netparams":[["123","456"]],"id":1}`,
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return btcjson.NewCmd(
					"gettxoutproof", []string{"123", "456"},
					btcjson.String("000000000000034a7dedef4a161fa058a2d67a173a90155f3a2fe6fc132e0ebf"),
				)
			},
			staticCmd: func() interface{} {
				return btcjson.NewGetTxOutProofCmd(
					[]string{"123", "456"},
					btcjson.String("000000000000034a7dedef4a161fa058a2d67a173a90155f3a2fe6fc132e0ebf"),
				)
			},
			marshalled: `{"jsonrpc":"1.0","method":"gettxoutproof","netparams":[["123","456"],` +
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getwork","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getwork","netparams":["00112233"],"id":1}`,
			unmarshalled: &btcjson.GetWorkCmd{
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"help","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"help","netparams":["getblock"],"id":1}`,
			unmarshalled: &btcjson.HelpCmd{
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"invalidateblock","netparams":["123"],"id":1}`,
		...
		},
		{
			...
			marshalled:   `{"jsonrpc":"1.0","method":"ping","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"preciousblock","netparams":["0123"],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"reconsiderblock","netparams":["123"],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"searchrawtransactions","netparams":["1Address"],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"searchrawtransactions","netparams":["1Address",0],"id":1}`,
			unmarshalled: &btcjson.SearchRawTransactionsCmd{
				Address:     "1Address",
				Verbose:     btcjson.Int(0),
				Skip:        btcjson.Int(0),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"searchrawtransactions","netparams":["1Address",0,5],"id":1}`,
			unmarshalled: &btcjson.SearchRawTransactionsCmd{
				Address:     "1Address",
				Verbose:     btcjson.Int(0),
				Skip:        btcjson.Int(5),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"searchrawtransactions","netparams":["1Address",0,5,10],"id":1}`,
			unmarshalled: &btcjson.SearchRawTransactionsCmd{
				Address:     "1Address",
				Verbose:     btcjson.Int(0),
				Skip:        btcjson.Int(5),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"searchrawtransactions","netparams":["1Address",0,5,10,1],"id":1}`,
			unmarshalled: &btcjson.SearchRawTransactionsCmd{
				Address:     "1Address",
				Verbose:     btcjson.Int(0),
				Skip:        btcjson.Int(5),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"searchrawtransactions","netparams":["1Address",0,5,10,1,true],"id":1}`,
			unmarshalled: &btcjson.SearchRawTransactionsCmd{
				Address:     "1Address",
				Verbose:     btcjson.Int(0),
				Skip:        btcjson.Int(5),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"searchrawtransactions","netparams":["1Address",0,5,10,1,true,["1Address"]],"id":1}`,
			unmarshalled: &btcjson.SearchRawTransactionsCmd{
				Address:     "1Address",
				Verbose:     btcjson.Int(0),
				Skip:        btcjson.Int(5),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"sendrawtransaction","netparams":["1122"],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"sendrawtransaction","netparams":["1122",false],"id":1}`,
			unmarshalled: &btcjson.SendRawTransactionCmd{
				HexTx:         "1122",
				AllowHighFees: btcjson.Bool(false),
			},
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"setgenerate","netparams":[true],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"setgenerate","netparams":[true,6],"id":1}`,
			unmarshalled: &btcjson.SetGenerateCmd{
				Generate:     true,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"submitblock","netparams":["112233"],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"submitblock","netparams":["112233",{"workid":"12345"}],"id":1}`,
			unmarshalled: &btcjson.SubmitBlockCmd{
				HexBlock: "112233",
				Options: &btcjson.SubmitBlockOptions{
					WorkID: "12345",
		...
		},
		{
			...
			marshalled:   `{"jsonrpc":"1.0","method":"uptime","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"validateaddress","netparams":["1Address"],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"verifychain","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"verifychain","netparams":[2],"id":1}`,
			unmarshalled: &btcjson.VerifyChainCmd{
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"verifychain","netparams":[2,500],"id":1}`,
			unmarshalled: &btcjson.VerifyChainCmd{
				CheckLevel: btcjson.Int32(2),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"verifymessage","netparams":["1Address","301234","test"],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"verifytxoutproof","netparams":["test"],"id":1}`,
