...
func TestWalletSvrCmds(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"addmultisigaddress","netparams":[2,["031234","035678"]],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"addmultisigaddress","netparams":[2,["031234","035678"],"test"],"id":1}`,
			unmarshalled: &btcjson.AddMultisigAddressCmd{
				NRequired: 2,
				Keys:      []string{"031234", "035678"},
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"addwitnessaddress","netparams":["1address"],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"dumpprivkey","netparams":["1Address"],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"encryptwallet","netparams":["pass"],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"estimatefee","netparams":[6],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"estimatepriority","netparams":[6],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getaccount","netparams":["1Address"],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getaccountaddress","netparams":["acct"],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getaddressesbyaccount","netparams":["acct"],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getbalance","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getbalance","netparams":["acct"],"id":1}`,
			unmarshalled: &btcjson.GetBalanceCmd{
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getbalance","netparams":["acct",6],"id":1}`,
			unmarshalled: &btcjson.GetBalanceCmd{
				Account: btcjson.String("acct"),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getrawchangeaddress","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getrawchangeaddress","netparams":["acct"],"id":1}`,
			unmarshalled: &btcjson.GetRawChangeAddressCmd{
				Account: btcjson.String("acct"),
			},
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getreceivedbyaccount","netparams":["acct"],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getreceivedbyaccount","netparams":["acct",6],"id":1}`,
			unmarshalled: &btcjson.GetReceivedByAccountCmd{
				Account: "acct",
				MinConf: btcjson.Int(6),
			},
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getreceivedbyaddress","netparams":["1Address"],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"getreceivedbyaddress","netparams":["1Address",6],"id":1}`,
			unmarshalled: &btcjson.GetReceivedByAddressCmd{
				Address: "1Address",
				MinConf: btcjson.Int(6),
			},
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"gettransaction","netparams":["123"],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"gettransaction","netparams":["123",true],"id":1}`,
			unmarshalled: &btcjson.GetTransactionCmd{
				Txid:             "123",
		...
		},
		{
			...
			marshalled:   `{"jsonrpc":"1.0","method":"getwalletinfo","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"importprivkey","netparams":["abc"],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"importprivkey","netparams":["abc","label"],"id":1}`,
			unmarshalled: &btcjson.ImportPrivKeyCmd{
				PrivKey: "abc",
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"importprivkey","netparams":["abc","label",false],"id":1}`,
			unmarshalled: &btcjson.ImportPrivKeyCmd{
				PrivKey: "abc",
				Label:   btcjson.String("label"),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"keypoolrefill","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"keypoolrefill","netparams":[200],"id":1}`,
			unmarshalled: &btcjson.KeyPoolRefillCmd{
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"listaccounts","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"listaccounts","netparams":[6],"id":1}`,
			unmarshalled: &btcjson.ListAccountsCmd{
				MinConf: btcjson.Int(6),
			},
		},
		{
			...
			marshalled:   `{"jsonrpc":"1.0","method":"listaddressgroupings","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled:   `{"jsonrpc":"1.0","method":"listlockunspent","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"listreceivedbyaccount","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"listreceivedbyaccount","netparams":[6],"id":1}`,
			unmarshalled: &btcjson.ListReceivedByAccountCmd{
				MinConf:          btcjson.Int(6),
				IncludeEmpty:     btcjson.Bool(false),
				IncludeWatchOnly: btcjson.Bool(false),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"listreceivedbyaccount","netparams":[6,true],"id":1}`,
			unmarshalled: &btcjson.ListReceivedByAccountCmd{
				MinConf:          btcjson.Int(6),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"listreceivedbyaccount","netparams":[6,true,false],"id":1}`,
			unmarshalled: &btcjson.ListReceivedByAccountCmd{
				MinConf:          btcjson.Int(6),
				IncludeEmpty:     btcjson.Bool(true),
				IncludeWatchOnly: btcjson.Bool(false),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"listreceivedbyaddress","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"listreceivedbyaddress","netparams":[6],"id":1}`,
			unmarshalled: &btcjson.ListReceivedByAddressCmd{
				MinConf:          btcjson.Int(6),
				IncludeEmpty:     btcjson.Bool(false),
				IncludeWatchOnly: btcjson.Bool(false),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"listreceivedbyaddress","netparams":[6,true],"id":1}`,
			unmarshalled: &btcjson.ListReceivedByAddressCmd{
				MinConf:          btcjson.Int(6),
				IncludeEmpty:     btcjson.Bool(true),
				IncludeWatchOnly: btcjson.Bool(false),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"listreceivedbyaddress","netparams":[6,true,false],"id":1}`,
			unmarshalled: &btcjson.ListReceivedByAddressCmd{
				MinConf:          btcjson.Int(6),
				IncludeEmpty:     btcjson.Bool(true),
				IncludeWatchOnly: btcjson.Bool(false),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"listsinceblock","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"listsinceblock","netparams":["123"],"id":1}`,
			unmarshalled: &btcjson.ListSinceBlockCmd{
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"listsinceblock","netparams":["123",6],"id":1}`,
			unmarshalled: &btcjson.ListSinceBlockCmd{
				BlockHash:           btcjson.String("123"),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"listsinceblock","netparams":["123",6,true],"id":1}`,
			unmarshalled: &btcjson.ListSinceBlockCmd{
				BlockHash:           btcjson.String("123"),
				TargetConfirmations: btcjson.Int(6),
				IncludeWatchOnly:    btcjson.Bool(true),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"listtransactions","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"listtransactions","netparams":["acct"],"id":1}`,
			unmarshalled: &btcjson.ListTransactionsCmd{
				Account:          btcjson.String("acct"),
				Count:            btcjson.Int(10),
				From:             btcjson.Int(0),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"listtransactions","netparams":["acct",20],"id":1}`,
			unmarshalled: &btcjson.ListTransactionsCmd{
				Account:          btcjson.String("acct"),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"listtransactions","netparams":["acct",20,1],"id":1}`,
			unmarshalled: &btcjson.ListTransactionsCmd{
				Account:          btcjson.String("acct"),
				Count:            btcjson.Int(20),
				From:             btcjson.Int(1),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"listtransactions","netparams":["acct",20,1,true],"id":1}`,
			unmarshalled: &btcjson.ListTransactionsCmd{
				Account:          btcjson.String("acct"),
				Count:            btcjson.Int(20),
				From:             btcjson.Int(1),
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"lockunspent","netparams":[true,[{"txid":"123","vout":1}]],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"move","netparams":["from","to",0.5],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"move","netparams":["from","to",0.5,6],"id":1}`,
			unmarshalled: &btcjson.MoveCmd{
				FromAccount: "from",
				ToAccount:   "to",
				Amount:      0.5,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"move","netparams":["from","to",0.5,6,"comment"],"id":1}`,
			unmarshalled: &btcjson.MoveCmd{
				FromAccount: "from",
				ToAccount:   "to",
				Amount:      0.5,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"setaccount","netparams":["1Address","acct"],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"settxfee","netparams":[0.0001],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"signmessage","netparams":["1Address","message"],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"signrawtransaction","netparams":["001122"],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"signrawtransaction","netparams":["001122",[{"txid":"123","vout":1,"scriptPubKey":"00","redeemScript":"01"}]],"id":1}`,
			unmarshalled: &btcjson.SignRawTransactionCmd{
				RawTx: "001122",
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"signrawtransaction","netparams":["001122",[],["abc"]],"id":1}`,
			unmarshalled: &btcjson.SignRawTransactionCmd{
				RawTx:    "001122",
				Inputs:   &[]btcjson.RawTxInput{},
				PrivKeys: &[]string{"abc"},
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"signrawtransaction","netparams":["001122",[],[],"ALL"],"id":1}`,
			unmarshalled: &btcjson.SignRawTransactionCmd{
				RawTx:    "001122",
				Inputs:   &[]btcjson.RawTxInput{},
				PrivKeys: &[]string{},
		...
		},
		{
			...
			marshalled:   `{"jsonrpc":"1.0","method":"walletlock","netparams":[],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"walletpassphrase","netparams":["pass",60],"id":1}`,
		...
		},
		{
			...
			marshalled: `{"jsonrpc":"1.0","method":"walletpassphrasechange","netparams":["old","new"],"id":1}`,
	...
	for i, test := range tests {
		...
		if e != nil  {
			t.Errorf("MarshalCmd #%d (%s) unexpected error: %v", i, test.name, e)
			continue
		}
