...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/parallelcointeam/parallelcoin/util/bloom)
...
```bash
$ go get -u github.com/parallelcointeam/parallelcoin/bloom
```

## Examples

- [NewFilter Example](http://godoc.org/github.com/parallelcointeam/parallelcoin/util/bloom#example-NewFilter)  
