...
// compressMagic is the magic byte used to identify a WIF encoding for an address created from a compressed serialized public key.
...
//  * Optional 1 byte (equal to 0x01) if the address being imported or exported was created by taking the RIPEMD160 after SHA256 hash of a serialized
