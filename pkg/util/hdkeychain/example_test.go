...
func ExampleNewMaster() {
	...
	log.Println("Private Extended Key?:", key.IsPrivate())
	// Output:
...
// 	//     number i of the HDW derived from master m.
// 	// Ordinarily this would either be read from some encrypted source and be decrypted or generated as the NewMaster example shows, but for the purposes of this example, the private extended key for the master node is being hard coded here.
...
// 		return
// 	}
// 	log.Println("Account 0 External Address 10:", acct0ExtAddr)
// 	log.Println("Account 0 Internal Address 0:", acct0IntAddr)
// 	// Output:
...
func Example_audits() {
	...
	//   * N(m/*)
	//   corresponds to the neutered master extended key (also called the master public extended key) Ordinarily this would either be read from some encrypted source and be decrypted or generated as the NewMaster example shows, but for the purposes of this example, the private extended key for the master node is being hard coded here.
	master := "xprv9s21ZrQH143K3QTDL4LXw2F7HEK3wJUD2nW2nRk4stbPy6cq3jPPqjiChkVvvNKmPGJxWUtg6LnF5kejMRNNU3TGtRBeJgk33yuGBxrMPHi"
	...
	log.Println("Audit key N(m/*):", masterPubKey)
	// Output:
