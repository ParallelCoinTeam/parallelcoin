...
[![GoDoc](https://godoc.org/github.com/parallelcointeam/parallelcoin/btcec?status.png)](http://godoc.org/github.com/parallelcointeam/parallelcoin/btcec)
...
```bash
$ go get -u github.com/parallelcointeam/parallelcoin/btcec
```

## Examples

- [Sign Message](http://godoc.org/github.com/parallelcointeam/parallelcoin/btcec#example-package--SignMessage)  
  Demonstrates signing a message with a secp256k1 private key that is first
  parsed form raw bytes and serializing the generated signature.

- [Verify Signature](http://godoc.org/github.com/parallelcointeam/parallelcoin/btcec#example-package--VerifySignature)  
  Demonstrates verifying a secp256k1 signature against a public key that is
  first parsed from raw bytes. The signature is also parsed from raw bytes.

- [Encryption](http://godoc.org/github.com/parallelcointeam/parallelcoin/btcec#example-package--EncryptMessage)
  Demonstrates encrypting a message for a public key that is first parsed from
  raw bytes, then decrypting it using the corresponding private key.

- [Decryption](http://godoc.org/github.com/parallelcointeam/parallelcoin/btcec#example-package--DecryptMessage)
