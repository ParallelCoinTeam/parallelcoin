...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/stalker-loki/pod/util/bloom)
...
```bash
$ go get -u github.com/stalker-loki/pod/bloom
```

## Examples

- [NewFilter Example](http://godoc.org/github.com/stalker-loki/pod/util/bloom#example-NewFilter)  
