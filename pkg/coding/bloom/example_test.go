...
func ExampleNewFilter() {
	...
	// Create a transaction hash and add it to the filter.  This particular transaction is the first transaction in block 310,000 of the main bitcoin block chain.
