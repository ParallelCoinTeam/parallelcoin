...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/stalker-loki/pod/peer)
...
```bash
$ go get -u github.com/stalker-loki/pod/peer
```

## Examples

- [New Outbound Peer Example](https://godoc.org/github.com/stalker-loki/pod/peer#example-package--NewOutboundPeer)  
