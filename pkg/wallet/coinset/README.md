...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/parallelcointeam/parallelcoin/coinset)
...
```bash
$ go get -u github.com/parallelcointeam/parallelcoin/coinset
```
