...
[![GoDoc](https://godoc.org/github.com/parallelcointeam/parallelcoin/walletmain/walletdb?status.png)]
(http://godoc.org/github.com/parallelcointeam/parallelcoin/walletmain/walletdb)
...
http://localhost:6060/pkg/github.com/parallelcointeam/parallelcoin/walletmain/walletdb

## Installation

```bash
$ go get github.com/parallelcointeam/parallelcoin/walletmain/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/parallelcointeam/parallelcoin/walletmain/walletdb#example-package--BasicUsage)  
