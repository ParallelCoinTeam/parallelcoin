...
func TestRegisterCmdErrors(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			e: btcjson.GeneralError{ErrorCode: btcjson.ErrDuplicateMethod},
		},
		{
			...
			e:   btcjson.GeneralError{ErrorCode: btcjson.ErrInvalidUsageFlags},
		},
		{
			name:   "invalid type",
			method: "registertestcmd",
		...
		},
		{
			...
			e: btcjson.GeneralError{ErrorCode: btcjson.ErrEmbeddedType},
		},
		{
			...
			e: btcjson.GeneralError{ErrorCode: btcjson.ErrUnexportedField},
		},
		{
			...
			e: btcjson.GeneralError{ErrorCode: btcjson.ErrUnsupportedFieldType},
		},
		{
		...
		},
		{
			...
			e: btcjson.GeneralError{ErrorCode: btcjson.ErrNonOptionalField},
		},
		{
			...
			e: btcjson.GeneralError{ErrorCode: btcjson.ErrNonOptionalDefault},
		},
		{
			...
			e: btcjson.GeneralError{ErrorCode: btcjson.ErrMismatchedDefault},
		},
	}
	t.Logf("Running %d tests", len(tests))
	for i, test := range tests {
