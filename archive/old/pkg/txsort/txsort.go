...
// For SortableInputSlice and SortableOutputSlice, three functions are needed to make it sortable with txsort.Sort() --
...
// First txsort based on input hash (reversed / rpc-style), then index.
...
// First txsort based on amount (smallest first), then PkScript.
