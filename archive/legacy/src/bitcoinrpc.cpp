                  ...
                  bool fAllowNull)
{
    ...
    BOOST_FOREACH(Value_type t, typesExpected)
    {
        ...
        {
            string e = strprintf("Expected type %s, got %s",
                  ...
                  bool fAllowNull)
{
    BOOST_FOREACH(const PAIRTYPE(string, Value_type)& t, typesExpected)
    {
        ...
        {
            string e = strprintf("Expected type %s for %s, got %s",
...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Parallelcoin server stopping";
}
...
string HTTPPost(const string& strMsg, const map<string,string>& mapRequestHeaders)
{
    ostringstream s;
    s << "POST / HTTP/1.1\r\n"
      << "User-Agent: parallelcoin-json-rpc/" << FormatFullVersion() << "\r\n"
      << "Host: 127.0.0.1\r\n"
...
static string HTTPReply(int nStatus, const string& strMsg, bool keepalive)
{
    if (nStatus == HTTP_UNAUTHORIZED)
        return strprintf("HTTP/1.0 401 Authorization Required\r\n"
            "Date: %s\r\n"
            "Server: parallelcoin-json-rpc/%s\r\n"
...
//
// JSON-RPC protocol.  Parallelcoin speaks version 1.0 for maximum compatibility,
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        string strWhatAmI = "To use parallelcoind";
