...
static const char qt_meta_stringdata_URITests[] = {
    "URITests\0\0uriTests()\0"
};
...
const QMetaObjectExtraData URITests::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject URITests::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_URITests,
      qt_meta_data_URITests, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &URITests::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_URITests))
        return static_cast<void*>(const_cast< URITests*>(this));
